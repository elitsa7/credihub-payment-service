...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleStripeException(StripeException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(buildError(HttpStatus.BAD_GATEWAY, ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(buildError(HttpStatus.INTERNAL_SERVER_ERROR,
